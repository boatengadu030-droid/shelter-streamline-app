...
import { Sprout, ArrowRight, ShieldCheck, FileCheck2, Sparkles, BarChart3 } from "lucide-react";
  ...
  return (
    <div className="relative flex h-screen w-full flex-col overflow-hidden bg-background text-foreground">
      ...
      <main className="relative z-10 flex flex-1 items-center">
        <div className="mx-auto grid w-full max-w-7xl items-center gap-8 px-6 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            ...
            <h1 className="reveal reveal-d1 mt-5 font-display text-[2.4rem] font-bold leading-[1.02] tracking-tight sm:text-5xl lg:text-[4.2rem]">
              Every child has a <span className="italic text-sheen">story</span>.
              <br />
              We help you tell it well.
            </h1>

            <p className="reveal reveal-d2 mt-5 max-w-xl text-sm text-muted-foreground sm:text-base">
            ...
            <div className="reveal reveal-d3 mt-6 flex flex-wrap items-center gap-3">
            ...
            <div className="reveal reveal-d4 mt-7 flex flex-wrap items-center gap-x-6 gap-y-2 text-[10px] uppercase tracking-[0.18em] text-muted-foreground">
          ...
          <div className="relative lg:col-span-5">
            <div className="relative mx-auto aspect-[4/5] w-full max-w-[360px] lg:max-w-md">
              ...
              <div className="reveal reveal-d2 absolute inset-0 overflow-hidden rounded-[2rem] border border-border/60 shadow-soft">
                <img
                  src={photo1}
                  alt="Children laughing together at a community home"
              ...
              <div className="reveal reveal-d3 absolute -bottom-5 -left-6 hidden w-40 rotate-[-6deg] overflow-hidden rounded-2xl border border-border/60 bg-card shadow-soft drift sm:block" style={{ animationDelay: "-2s" }}>
              ...
              <div className="reveal reveal-d4 absolute -top-5 -right-4 hidden w-44 rotate-[5deg] rounded-2xl border border-border/60 bg-card p-3.5 shadow-soft drift sm:block" style={{ animationDelay: "-4s" }}>
